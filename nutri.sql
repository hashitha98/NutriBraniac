...
CREATE TABLE `book` (
  ...
  `times` varchar(300) COLLATE utf8_unicode_ci NOT NULL,
  `date` varchar(300) COLLATE utf8_unicode_ci NOT NULL,
  `descri` varchar(400) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `book` (`bookid`, `price`, `times`, `date`, `descri`, `img`) VALUES
(3, 'Starting at $5', '45 min', 'May 03, 2020 12.00PM', 'A nutritional counselor helps people to set achievable health goals', 'up/fb445107397ff451c4b035b02b923563.PNG');
...
(3, 0, 'General Discussions', 'general-discussions', 'For anything and everything that doesnt fit in other categories.', 'bubbles.png', 0, 0, 0, 0, 1, 2),
...
(1, 'site_url', ''),
(2, 'site_title', 'NutriBraniac'),
(3, 'site_description', 'NutriBraniac - Enhancing your experience with next generation gym!'),
(4, 'admin_email', 'admin@NutriBraniac.com'),
(5, 'theme', '2k18'),
...
(1, 'core', 'recurrence', 86400, 1588607296, 1588607296, 0),
(2, 'daily_digest', 'recurrence', 86400, 1588607296, 1588607296, 0),
(3, 'weekly_digest', 'recurrence', 604800, 1588085589, 1588085590, 0),
(4, 'mail_notify_send', 'recurrence', 1800, 1588609542, 1588609542, 0),
(5, 'forum_update', 'recurrence', 3600, 1588607296, 1588607296, 0);
...
(1, 0, 'Info', 'Unable to fetch user data User.php:39 vals= Array\n(\n    [username] => admin@admin.com\n)\n Array\n(\n    [5ea84310c3bc2view_inserted] => 1\n    [5ea84310c3bc6_csrf] => 9e2ee85da91d380056433048e14a2f0a\n)\n', 6, 'Trace: Array\n(\n    [0] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\fit\\forum\\sys\\CODOF\\Log.php\n            [line] => 97\n            [function] => get_trace\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                )\n\n        )\n\n    [1] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\fit\\forum\\sys\\CODOF\\Log.php\n            [line] => 73\n            [function] => set_options\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => Array\n                        (\n                            [log_type] => Info\n                        )\n\n                    [1] => Unable to fetch user data User.php:39 vals= Array\n(\n    [username] => admin@admin.com\n)\n Array\n(\n    [5ea84310c3bc2view_inserted] => 1\n    [5ea84310c3bc6_csrf] => 9e2ee85da91d380056433048e14a2f0a\n)\n\n                )\n\n        )\n\n    [2] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\fit\\forum\\sys\\CODOF\\Util.php\n            [line] => 31\n            [function] => info\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => Unable to fetch user data User.php:39 vals= Array\n(\n    [username] => admin@admin.com\n)\n Array\n(\n    [5ea84310c3bc2view_inserted] => 1\n    [5ea84310c3bc6_csrf] => 9e2ee85da91d380056433048e14a2f0a\n)\n\n                )\n\n        )\n\n    [3] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\fit\\forum\\sys\\CODOF\\User\\User.php\n            [line] => 853\n            [function] => log\n            [class] => CODOF\\Util\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => Unable to fetch user data User.php:39 vals= Array\n(\n    [username] => admin@admin.com\n)\n Array\n(\n    [5ea84310c3bc2view_inserted] => 1\n    [5ea84310c3bc6_csrf] => 9e2ee85da91d380056433048e14a2f0a\n)\n\n                )\n\n        )\n\n    [4] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\fit\\forum\\sys\\CODOF\\User\\User.php\n            [line] => 666\n            [function] => getUserObject\n            [class] => CODOF\\User\\User\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => SELECT u.*,r.rid,r.is_primary FROM codo_users AS u LEFT JOIN codo_user_roles r ON u.id=r.uid WHERE u.username=:username\n                    [1] => Array\n                        (\n                            [username] => admin@admin.com\n                        )\n\n                    [2] => PDO Object\n                        (\n                        )\n\n                )\n\n        )\n\n    [5] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\fit\\forum\\sys\\CODOF\\User\\Login.php\n            [line] => 93\n            [function] => getByUsername\n            [class] => CODOF\\User\\User\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => admin@admin.com\n                )\n\n        )\n\n    [6] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\fit\\forum\\sys\\CODOF\\User\\Login.php\n            [line] => 55\n            [function] => getUserByIdentifier\n            [class] => CODOF\\User\\Login\n            [object] => CODOF\\User\\Login Object\n                (\n                    [identifier] => admin@admin.com\n                    [password] => admin\n                    [db:CODOF\\User\\Login:private] => PDO Object\n                        (\n                        )\n\n                )\n\n            [type] => ->\n            [args] => Array\n                (\n                    [0] => admin@admin.com\n                )\n\n        )\n\n    [7] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\fit\\forum\\sys\\Controller\\Ajax\\user\\login.php\n            [line] => 23\n            [function] => process_login\n            [class] => CODOF\\User\\Login\n            [object] => CODOF\\User\\Login Object\n                (\n                    [identifier] => admin@admin.com\n                    [password] => admin\n                    [db:CODOF\\User\\Login:private] => PDO Object\n                        (\n                        )\n\n                )\n\n            [type] => ->\n            [args] => Array\n                (\n                )\n\n        )\n\n    [8] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\fit\\forum\\routes.php\n            [line] => 598\n            [function] => dologin\n            [class] => Controller\\Ajax\\user\\login\n            [object] => Controller\\Ajax\\user\\login Object\n                (\n                    [db] => PDO Object\n                        (\n                        )\n\n                )\n\n            [type] => ->\n            [args] => Array\n                (\n                )\n\n        )\n\n    [9] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\fit\\forum\\sys\\Ext\\limonade\\limonade.php\n            [line] => 421\n            [function] => {closure}\n            [args] => Array\n                (\n                )\n\n        )\n\n    [10] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\fit\\forum\\sys\\CODOF\\Access\\Request.php\n            [line] => 94\n            [function] => run\n            [args] => Array\n                (\n                )\n\n        )\n\n    [11] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\fit\\forum\\routes.php\n            [line] => 952\n            [function] => start\n            [class] => CODOF\\Access\\Request\n            [type] => ::\n            [args] => Array\n                (\n                )\n\n        )\n\n    [12] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\fit\\forum\\index.php\n            [line] => 14\n            [args] => Array\n                (\n                    [0] => C:\\xampp\\htdocs\\fit\\forum\\routes.php\n                )\n\n            [function] => require\n        )\n\n)\n', 1588607288),
(2, 0, 'Info', 'Failed login attempt for admin@admin.com. Wrong credentials', 6, 'Trace: Array\n(\n    [0] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\fit\\forum\\sys\\CODOF\\Log.php\n            [line] => 97\n            [function] => get_trace\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                )\n\n        )\n\n    [1] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\fit\\forum\\sys\\CODOF\\Log.php\n            [line] => 73\n            [function] => set_options\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => Array\n                        (\n                            [log_type] => Info\n                        )\n\n                    [1] => Failed login attempt for admin@admin.com. Wrong credentials\n                )\n\n        )\n\n    [2] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\fit\\forum\\sys\\CODOF\\User\\Login.php\n            [line] => 80\n            [function] => info\n            [class] => CODOF\\Log\n            [type] => ::\n            [args] => Array\n                (\n                    [0] => Failed login attempt for admin@admin.com. Wrong credentials\n                )\n\n        )\n\n    [3] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\fit\\forum\\sys\\Controller\\Ajax\\user\\login.php\n            [line] => 23\n            [function] => process_login\n            [class] => CODOF\\User\\Login\n            [object] => CODOF\\User\\Login Object\n                (\n                    [identifier] => admin@admin.com\n                    [password] => admin\n                    [db:CODOF\\User\\Login:private] => PDO Object\n                        (\n                        )\n\n                )\n\n            [type] => ->\n            [args] => Array\n                (\n                )\n\n        )\n\n    [4] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\fit\\forum\\routes.php\n            [line] => 598\n            [function] => dologin\n            [class] => Controller\\Ajax\\user\\login\n            [object] => Controller\\Ajax\\user\\login Object\n                (\n                    [db] => PDO Object\n                        (\n                        )\n\n                )\n\n            [type] => ->\n            [args] => Array\n                (\n                )\n\n        )\n\n    [5] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\fit\\forum\\sys\\Ext\\limonade\\limonade.php\n            [line] => 421\n            [function] => {closure}\n            [args] => Array\n                (\n                )\n\n        )\n\n    [6] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\fit\\forum\\sys\\CODOF\\Access\\Request.php\n            [line] => 94\n            [function] => run\n            [args] => Array\n                (\n                )\n\n        )\n\n    [7] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\fit\\forum\\routes.php\n            [line] => 952\n            [function] => start\n            [class] => CODOF\\Access\\Request\n            [type] => ::\n            [args] => Array\n                (\n                )\n\n        )\n\n    [8] => Array\n        (\n            [file] => C:\\xampp\\htdocs\\fit\\forum\\index.php\n            [line] => 14\n            [args] => Array\n                (\n                    [0] => C:\\xampp\\htdocs\\fit\\forum\\routes.php\n                )\n\n            [function] => require\n        )\n\n)\n', 1588607288);
...
('nicc7he2t1c0ihpbqmn5kbeqk7', 1588611709, '5ea84310c3bc2view_inserted|b:1;5ea84310c3bc6_csrf|s:32:"9e2ee85da91d380056433048e14a2f0a";5ea84310c3bc2USER|a:1:{s:2:"id";i:1;}5ea84310c3bc2A_loggedin_created|s:14:"April 28, 2020";5ea84310c3bc2A_loggedin_avatar|s:79:"http://localhost/fit/forum/sites/default/assets/img/profiles/icons/A_4700b3.png";5ea84310c3bc2A_loggedin_username|s:5:"admin";5ea84310c3bc2A_loggedin|s:5:"admin";codo_zombie_crons_cleanup|b:1;');
...
(1, 'Welcome to Codoforum', 3, 1, 1, 0, NULL, NULL, 1401549322, 0, 0, 1401549322, 0, 1, 0, NULL);
...
INSERT INTO `codo_unread_topics` (`cat_id`, `topic_id`, `uid`, `read_time`) VALUES
(3, 1, 1, 1588085600);
...
(1, 'admin', 'admin', '$2a$08$Q.Cwhx6fHv1o1TwxMRgraeObYY4zXt2JuTJIcJxPMM.jpWn5Kn5GS', NULL, 'admin@admin.com', 1588085545, 1588607315, 0, 1, 'A_4700b3.png', NULL, 0, 0, '0', 0, 0),
(2, 'anonymous', 'Anonymous', 'youJustCantCrackThis', '', 'anonymous@localhost', 1588085545, 1588085545, 0, 0, '', '', 0, 0, '0', 0, 0);
...
CREATE TABLE `items` (
  ...
  `item_sname` varchar(5000) NOT NULL DEFAULT '',
  `item_name` varchar(5000) NOT NULL DEFAULT '',
  `item_category` varchar(5000) NOT NULL DEFAULT '',
...
INSERT INTO `items` (`item_id`, `item_sname`, `item_name`, `item_category`, `item_price`, `item_image`, `item_date`) VALUES
(1, 'Whey Protein ', 'Gold Whey Protein', 'Supplement', 11500, 'up/c4912b9504b8a66f7e629820c8d9d369.jpg', '2020-05-01'),
(4, 'Men Skinny', 'Men Skinny', '', 1000, '786134.jpg', '2020-05-04'),
(5, 'BAAC', 'BAAC Anabolic Supplement', '', 15000, '277030.jpg', '2020-05-04'),
(6, 'GYM KIT', 'Men Full GYM KIT', '', 3500, '775585.jpg', '2020-05-04');
...
CREATE TABLE `plans` (
  ...
  `descri` varchar(800) COLLATE utf8_unicode_ci DEFAULT NULL,
  `imgurl` varchar(200) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `plans` (`planid`, `price`, `sname`, `descri`, `imgurl`) VALUES
(1, '1500 LKR', 'Gym training workout program', 'We have provided you with the tools you can use to create your personalized workout at your local gym. Whether you are aiming to lose unwanted weight, tone or add some new muscle size this program is for you. Utilizing the many different variations of fitness machines and free weights will come to your advantage. You are in control over variables such as how many days and which days you are available for exercise, and which exercise equipment you have available. We make it very simple by planning out each day, exercise, total number of repetitions and sets to help you succeed with your goal. This is your personalized fitness plan - designed specifically your requirements. Best of luck and be sure to stay committed.', 'up/9e7c1d0a61b31a5109dd02c787396404.jpg');
...
CREATE TABLE `shop` (
  ...
  `price` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `shortname` varchar(300) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `shop` (`proid`, `price`, `shortname`, `name`, `category`, `imgurl`) VALUES
(1, '11500 LKR', 'Whey Protein', 'Gold Whey Protein', 'Supplement', '/up/c4912b9504b8a66f7e629820c8d9d369.jpg'),
(2, '2000 LKR', 'Men Skinny', 'Men Skinny', 'Clothes', '/up/ed69b5348d7c2c32a3ec70a269257465.jpg'),
(3, '14500 LKR', 'BCAA Supplement', 'Anabolic Bpi BCAA Dietary Supplement', 'Supplement', '/up/d9da265e2e179a19bc3223abb7801f88.jpg');
...
(1, 'admin@admin.com', 'asd', 'Test', 'Bot', '50');
...
--
ALTER TABLE `plans`
  MODIFY `planid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `shop`
--
ALTER TABLE `shop`
  MODIFY `proid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
